...
<div class="max-w-2xl sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-xl bg-white text-gray-900">
    ...
    <!-- profile card start -->
    <div class="flex-shrink-0 m-2 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg group">
        ...
        <div class="relative text-white px-2 pb-2 mt-6">
            <span class="block opacity-75 mb-1">{{$getRecord()->user->name}}</span>
            <span class="block font-semibold text-xl text-wrap">{{$getRecord()->institution_name}}</span>
            <div class="flex justify-between items-center mt-2">
                <span class="block text-sm font-semibold">{{$getRecord()->rating}}<span class="text-xs">/5</span></span>
...
{{--    <ul class="mt-4 text-gray-700 flex items-center justify-around">--}}
...
{{--    <div class="pt-4 border-t mx-8 mt-2 flex justify-between items-center">--}}
...
{{--        </svg>--}}
{{--        <span class="text-slate-100 bg-teal-800 px-2 py-0.5 rounded-full shadow">--}}
