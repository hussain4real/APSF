        ...
        <div class="w-full h-screen flex flex-col items-center justify-between bg-black bg-opacity-70 py-8">
            <div class="flex-1 flex flex-col items-center justify-center">
                <div class="bg-white bg-opacity-10 px-4 py-2 rounded-xl flex items-center justify-center text-cyan-100 space-x-2 lg:space-x-4">
                    ...
                    <span class="text-xl lg:text-2xl xl:text-3xl font-bold">APSF</span>
                </div>
                <h1 class="text-6xl text-white lg:text-7xl xl:text-8xl tracking-wider font-bold font-serif mt-12 text-center">Coming Soon</h1>
                <div class="flex flex-col items-center space-y-4 mt-24">
                    <p class="text-slate-100 uppercase text-sm">Notify me when it's ready</p>
                    <form class="w-full flex items-center">
                        <input type="email" name="email" id="email" class="w-72 p-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded-tl rounded-bl text-md" placeholder="Email" autocomplete="off">
                        <button class="bg-teal-600 hover:bg-teal-700 py-2 px-6 text-slate-100 border border-teal-600 rounded-tr rounded-br text-md">Subscribe</button>
                    </form>
                </div>
            </div>
                ...
                <ul class="flex items-center space-x-4">
                    <li>
                        <a href="#" title="Facebook">
                            <svg class="w-6 lg:w-8 h-6 lg:h-8 hover:scale-110 transition duration-300" fill="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 506.86 506.86">
                                <defs>
                                    <style>
                                        .cls-1{fill:#E4622C;}
                                    </style>
