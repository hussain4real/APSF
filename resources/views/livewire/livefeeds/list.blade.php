...
#[Layout('layouts.app')]
 class extends Component {
    ...
    {
        $this->livefeeds = \App\Models\Livefeed::with('user')
            ->latest()
            ->get();
    }
            ...
            <div class="flex-1">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <small class="ml-2 text-sm text-gray-600">{{ $livefeed->created_at->format('j M Y, g:i a') }}</small>
                    ...
                    @if ($livefeed->user->is(auth()->user()))
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link wire:click="delete({{ $livefeed->id }})" wire:confirm="Are you sure to delete this chirp?">
                                    {{ __('Delete') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
