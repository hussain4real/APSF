            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="voteForm">
                        ...
                        <button id="submit-button" type="submit" class="btn btn-primary">{{__('frontend.votes.vote')}}</button>
                    </form>
                    @auth
                    <button id="viewVotes" class="btn btn-outline-info d-flex mt-3">{{__('frontend.votes.view_votes')}}</button>
                    @endauth
                </div>
            </div>
        </div>
