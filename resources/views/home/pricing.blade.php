            ...
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                ...
                <div class="col" >
                    <div id="pricing-card" class="card mb-4 rounded-3 shadow-sm title-wrap">
                        ...
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title mt-4">${{$plan['price']}}<small class="text-body-secondary fw-light">/yr</small></h1>
                            <ul class="mt-4 mb-4 features breadcrumb">
                                @forelse($plan['features'] as $feature)
                                <li>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
                                            <path d="M3.854 8.354a.5.5 0 0 1 .353-.854h.853a.5.5 0 0 1 0 1H4.207l-.354.353a.5.5 0 0 1-.353.854z"/>
                                            <path d="M6.354 8.354a.5.5 0 0 1 .353-.854h.853a.5.5 0 0 1 0 1H6.707l-.354.353a.5.5 0 0 1-.353.854z"/>
                                            <path d="M11.354 8.354a.5.5 0 0 1 .353-.854h.853a.5.5 0 0 1 0 1h-.853l-.353.353a.5.5 0 0 1-.854-.353z"/>
                                            <path d="M8 1a7 7 0 0 0-7 7c0 3.182 2.118 5.86 5 6.75V14a1 1 0 0 1 2 0v.75c2.882-.89 5-3.568 5-6.75a7 7 0 0 0-7-7zm0 12a5 5 0 0 1-5-5 5 5 0 0 1 10 0 5 5 0 0 1-5 5z"/>
                                        </svg>
                                    </span>
                                    {{$feature}}
                                </li>
