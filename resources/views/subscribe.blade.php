<x-home-layout>
    ...
    <div class="container mx-auto">
        ...
        <form id='pay2m_payment_form' name='pay2m-payment-form' method='post'
              action="https://payments.pay2m.com/Ecommerce/api/Transaction/PostTransaction" class="hidden">
            {{--        @csrf--}}
            <!-- ... -->
            ...
            <input type="TEXT" name="CUSTOMER_EMAIL_ADDRESS" value="some-email@example.com" hidden="true"
                   readonly/><br/>
...
{{--                                                    @dd($membershipData)--}}
                            @foreach($membershipData as $membership)
                                    ...
                                    <h4 class="fs-5 text-muted">{{$membership['currency']}} {{$membership['price']}}</h4>
