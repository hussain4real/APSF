<x-home-layout>
    ...
    <div class="container mx-auto">
        ...
        <form id='pay2m_payment_form' name='pay2m-payment-form' method='post' action="https://pay.pay2m.com/Ecommerce/api/Transaction/PostTransaction" class="hidden">
            ...
            <input type="TEXT" name="SUCCESS_URL" value="{{route('payment.response',['recurring'=>'yes'])}}" hidden="true" readonly /><br />
            <input type="TEXT" name="FAILURE_URL" value="{{route('payment.failed',['recurring'=>'yes'])}}" hidden="true" readonly /><br />
